...
if __name__=='__main__':
    ...
    # data_filename = '../data/intermediate/raju.p'#snakemake.input[0]
    # lfads_filename = '../data/model_output/raju_2OLS24_all.h5' #snakemake.input[1]
    # input_info_file = '../data/model_output/raju_inputInfo.mat' #snakemake.input[2]
    #data_filename = '../data/intermediate/mack.p'#snakemake.input[0]
    #lfads_filename = '../data/model_output/mack_2OLS24_all.h5' #snakemake.input[1]
    #input_info_file = '../data/model_output/mack_inputInfo.mat' #snakemake.input[2]
