...
if __name__=='__main__':
    ...
    plt.savefig(os.path.join(os.path.dirname(__file__), '../figures/final_figures/numbered/7c-datasets.pdf'))
    ...
    plt.savefig(os.path.join(os.path.dirname(__file__), '../figures/final_figures/numbered/7c-combined.pdf'))