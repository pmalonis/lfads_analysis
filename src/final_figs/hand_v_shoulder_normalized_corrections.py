...
if __name__=='__main__':
    plot_data_path = os.path.join(os.path.dirname(__file__), '../../data/model_output/hand_v_shoulder_corrections_normalized.p')
...
plt.savefig(os.path.join(os.path.dirname(__file__), '../../figures/final_figures/numbered/6f.pdf'))
