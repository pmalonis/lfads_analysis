...
if __name__=='__main__':
    ...
    for dataset, param in zip(datasets, params):
        ...
        for thresh_idx,threshold in enumerate(thresholds):
            ...
            if os.path.exists(peak_path):
                ...
                peak_df = ta.get_peak_df(df, co, trial_len, threshold, dt, win_start=win_start, win_stop=win_stop)
        ...
        # plt.xlabel('Latency for input %d (ms)'%(i+1))
    ...
    plt.savefig('../../figures/final_figures/peak_timing.png')