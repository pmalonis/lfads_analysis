...
if __name__=='__main__':
    plot_data_path = os.path.join(os.path.dirname(__file__), '../../data/model_output/hand_v_shoulder_correction_magnitude.p')
    if os.path.exists(plot_data_path):
        all_plot_dfs = pd.read_pickle(plot_data_path)
    else:
        output_filename = os.path.join(os.path.dirname(__file__), '../../data/peaks/params_search_corrections.csv')
        ...
        run_info = yaml.safe_load(os.path.join(os.path.dirname(__file__), '../../lfads_file_locations.yml'), 'r')
        ...
        for dataset in datasets:
            ...
            peak_filename = os.path.join(os.path.dirname(__file__), '../../data/peaks/' + '_'.join([dataset, 'corrections_test.p']))
    ...
    plt.savefig(os.path.join(os.path.dirname(__file__), '../../figures/final_figures/numbered/6g.pdf'))
