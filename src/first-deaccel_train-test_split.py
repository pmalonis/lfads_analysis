...
# train_filename = "../data/peaks/rockstar_first-accel_train.p"
# test_filename = "../data/peaks/rockstar_first-accel_test.p"
# all_filename = "../data/peaks/rockstar_first-accel_all.p"
...
def split_firstmove_df(df):
    ...
    transition_df = ss.dataset_events(df, ss.trial_first_accel)#, exclude_post_target=0,exclude_pre_target=0)
